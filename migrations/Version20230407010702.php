...
final class Version20230407010702 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE team_invite (id UUID NOT NULL, team_id UUID DEFAULT NULL, access_level VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, expires_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
